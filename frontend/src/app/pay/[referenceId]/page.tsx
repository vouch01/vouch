...
//       if (result.found) {
//         setLocation(`/success/${id}`);
//       } else {
//         setPaymentStatus("error");
//         toast({
//           variant: "destructive",
//           title: "Payment not detected yet.",
//           description: "Please ensure you have transferred the funds.",
//         });
//       }
//     } catch (err) {
//       setPaymentStatus("error");
...
//   if (isLoading) {
//     return (
//       <div className="min-h-[100dvh] bg-background max-w-[480px] mx-auto w-full flex flex-col">
//         <Header />
...
//             <span className="text-sm text-muted-foreground font-medium">{transaction.sellerName}</span>
//             <span className="text-xs text-muted-foreground/80 mb-2">{transaction.sellerPhone}</span>
//             <span className="text-base font-semibold text-foreground">{transaction.productName}</span>
//             <span className="text-sm text-muted-foreground">{transaction.productDescription}</span>
...
//                   <span className="text-sm font-semibold">{transaction.accountNumber}</span>
//                   <button onClick={handleCopyAccount} className="text-primary hover:bg-secondary p-1 rounded-md transition-colors">
...
//                 <span className="text-sm font-semibold">{transaction.bankName}</span>
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="text-sm text-muted-foreground">Account Name</span>
//                 <span className="text-sm font-semibold">{transaction.accountName}</span>
//               </div>
//             </div>
//           </CardContent>
//         </Card>
