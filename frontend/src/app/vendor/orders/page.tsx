...
export default function OrdersPage() {
  ...
  const filteredOrders = orders.filter((o) => {
    if (filter !== "All" && filter !== o.status) {
      if (filter === "Ready to Ship" && o.status !== "PAID_IN_ESCROW")
        return false;
      if (filter === "Pending Payment" && o.status !== "PENDING_PAYMENT")
        return false;
  ...
  const tabs = [
    ...
    },
    {
      label: "Ready to Ship",
      value: "Ready to Ship",
      count: orders.filter((o) => o.status === "PAID_IN_ESCROW").length,
    },
    {
      label: "Dispatched",
      value: "Dispatched",
    ...
    },
    {
      label: "Settled",
      value: "Settled",
      count: orders.filter((o) => o.status === "SETTLED").length,
    },
  ];
